...
<body class="bg-gray-100">
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-8">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-800">Kelola Terapis</h1>
                <p class="text-gray-500 mt-1">Manajemen data terapis Beautybar</p>
            </div>
            ...
            <div id="therapistModal"
                ...
                <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4">
                    ...
                    <form method="POST" id="therapistForm" class="p-6" enctype="multipart/form-data">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="px-6 py-4 border-b bg-gradient-to-r from-purple-50 to-purple-100">
                    <h2 class="text-xl font-bold text-gray-800">👨‍⚕️ Daftar Terapis</h2>
                </div>
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="space-y-2 mb-4">
                                        <div class="flex items-center text-sm text-gray-600">
                                            ...
                                            <span><?php echo htmlspecialchars($therapist['phone']); ?></span>
                                        </div>
                                        
                                        <div class="flex items-start text-sm text-gray-600">
                                            <span class="mr-2 mt-1">💼</span>
                                            <span class="flex-1"><?php echo htmlspecialchars($therapist['specialization']); ?></span>
                                        </div>
                                    </div>
                ...
                <?php else: ?>
                    <div class="p-12 text-center text-gray-500">
                        ...
                        <p class="text-lg font-medium">Belum ada terapis yang terdaftar</p>
                        <p class="text-sm mt-2">Klik tombol "Tambah Terapis Baru" untuk menambahkan terapis pertama</p>
                    </div>
                <?php endif; ?>
            </div>
        </main>

        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div class="bg-purple-600 px-6 py-8 text-white text-center">
                    ...
                    <p class="text-3xl md:text-4xl font-bold mt-2">Rp <?php echo number_format($amount, 0, ',', '.'); ?></p>
                </div>
                ...
                <form action="payment_process.php" method="POST" enctype="multipart/form-data" class="p-6 md:p-8">
                    ...
                    <!-- BRI Payment Info -->
                    <div id="info_BRI" class="payment-box mb-6">
                        <div class="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 text-center">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/6/68/BANK_BRI_logo.svg" 
                                 alt="BRI" class="h-12 mx-auto mb-4">
                            <p class="text-sm text-gray-600 mb-2">Nomor Virtual Account (BRIVA):</p>
                            <div class="bg-white rounded-lg p-4 mb-3">
                                <p class="text-2xl md:text-3xl font-bold text-gray-800 tracking-wider" id="text_BRI">8801234567890</p>
                            </div>
                            <p class="text-sm text-gray-600 mb-3">a.n Beautybar Official</p>
                            <button type="button" onclick="copyToClipboard('text_BRI')" 
                    ...
                    <div id="info_BCA" class="payment-box mb-6">
                        <div class="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 text-center">
                            ...
                            <div class="bg-white rounded-lg p-4 mb-3">
                                <p class="text-2xl md:text-3xl font-bold text-gray-800 tracking-wider" id="text_BCA">1234567890</p>
                            </div>
                    ...
                    <div id="info_Mandiri" class="payment-box mb-6">
                        <div class="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-6 text-center">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/a/ad/Bank_Mandiri_logo_2016.svg" 
                                 alt="Mandiri" class="h-12 mx-auto mb-4">
                            <p class="text-sm text-gray-600 mb-2">Nomor Rekening Mandiri:</p>
                            <div class="bg-white rounded-lg p-4 mb-3">
                                <p class="text-2xl md:text-3xl font-bold text-gray-800 tracking-wider" id="text_Mandiri">1110004567890</p>
                            </div>
                            <p class="text-sm text-gray-600 mb-3">a.n Beautybar Official</p>
                            <button type="button" onclick="copyToClipboard('text_Mandiri')" 
                    ...
                    <!-- DANA Payment Info -->
                    <div id="info_DANA" class="payment-box mb-6">
                        <div class="bg-cyan-50 border-2 border-cyan-200 rounded-xl p-6 text-center">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/7/72/Logo_dana_blue.svg" 
                                 alt="DANA" class="h-12 mx-auto mb-4">
                            <p class="text-sm text-gray-600 mb-2">Nomor DANA:</p>
                            <div class="bg-white rounded-lg p-4 mb-3">
                                <p class="text-2xl md:text-3xl font-bold text-gray-800 tracking-wider" id="text_DANA">081234567890</p>
                            </div>
                            <p class="text-sm text-gray-600 mb-3">a.n Beauty Admin</p>
                            <button type="button" onclick="copyToClipboard('text_DANA')" 
                                    class="px-4 py-2 bg-cyan-600 text-white rounded-lg hover:bg-cyan-700 transition text-sm font-semibold">
                                📋 Salin Nomor
                            </button>
                        </div>
                    </div>

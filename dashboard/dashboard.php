    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-500 mt-1">Selamat datang di panel admin Beautybar</p>
            </div>
                ...
                <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold mt-2"><?php echo $stats['total_members']; ?></h3>
                ...
                <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold mt-2"><?php echo $stats['total_treatments']; ?></h3>
                ...
                <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold mt-2"><?php echo $stats['pending_bookings']; ?></h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-white rounded-xl shadow-md p-6">
                    ...
                    <p class="text-3xl font-bold text-green-600"><?php echo $stats['completed_bookings']; ?></p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <!-- Booking Chart -->
                <div class="bg-white rounded-xl shadow-md p-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">Booking 7 Hari Terakhir</h3>

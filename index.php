        ...
        <div class="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div class="space-y-4">
                ...
                <div class="faq-item border border-gray-200 rounded-xl overflow-hidden">
                    ...
                    <div class="faq-answer max-h-0 overflow-hidden transition-all duration-300">
                        <div class="px-6 pb-6 text-gray-600 leading-relaxed">
                            Jika berhalangan hadir, pelanggan hanya dapat melakukan reschedule dan tidak tersedia
                            refund, baik pembatalan dilakukan pada H-2, H-1, H-0, maupun no-show.
                            Reschedule dapat dilakukan melalui WhatsApp atau dashboard.
                        </div>
                    </div>
                </div>

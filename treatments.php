        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:flex items-center gap-8">
                    ...
                    <a href="treatments.php" class="text-gray-600 hover:text-primary font-medium text-sm transition-colors relative group">
                        Treatment
                ...
                <div class="flex-1 overflow-x-auto scrollbar-hide">
                    <div class="flex gap-3 pb-2">
                        <a href="treatments.php"
                            ...
                            Semua
                            <span class="px-2 py-0.5 rounded-full text-xs font-semibold <?= $selected_category == 0 ? 'bg-white/20' : 'bg-white' ?>">
                        ...
                        <a href="treatments.php?category=<?= $cat['id'] ?>"
                            ...
                            <span class="px-2 py-0.5 rounded-full text-xs font-semibold <?= $selected_category == $cat['id'] ? 'bg-white/20' : 'bg-white' ?>">
                                <?= $cat['treatment_count'] ?>
                            </span>
                        </a>
                        <?php endif; ?>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="treatments-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                ...
                <div class="treatment-card bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-2xl group" 
                    ...
                    <div class="treatment-image relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                        <?php if ($image_src): ?>
                        ...
                        <div class="absolute top-3 left-3 bg-white/95 backdrop-blur-sm text-accent px-2.5 py-1 rounded-full text-xs font-bold shadow-lg">
                    ...
                    <div class="treatment-content p-5">
                        <div class="treatment-info">
                            <h3 class="text-base font-semibold mb-2 text-gray-800 group-hover:text-accent transition-colors line-clamp-2">
                                <?= htmlspecialchars($treatment['name']) ?>
                            </h3>

                            <div class="treatment-meta-wrapper">
                                <div class="treatment-price-duration flex items-center justify-between mb-4 pb-3 border-b border-gray-100">
                                    <div>
            ...
            <div class="text-center py-20">
                ...
                <a href="treatments.php" class="inline-flex items-center gap-2 px-8 py-3.5 bg-primary text-white hover:bg-black transition-all text-sm font-medium rounded-lg">
    ...
    <script>
        ...
        function searchTreatments() {
            ...
            cards.forEach(card => {
                ...
                const categoryFilter = card.style.display === 'none' && !card.classList.contains('category-hidden');
        ...
        viewButtons.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                if (view === 'list') {
                    ...
                    grid.classList.remove('grid', 'grid-cols-1', 'sm:grid-cols-2', 'lg:grid-cols-4', 'xl:grid-cols-5');
                } else {
                    grid.classList.remove('list-view');
                    grid.classList.add('grid', 'grid-cols-1', 'sm:grid-cols-2', 'lg:grid-cols-4', 'xl:grid-cols-5');
                }
            });
        });
